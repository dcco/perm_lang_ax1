...
lemma self_minus_leq_use_env: "leq_use_env (minus_use_env r_s r_x) r_s"    
...
lemma minus_leq_use_env: "\<lbrakk> leq_use_env r_x r_s \<rbrakk> \<Longrightarrow> leq_use_env (minus_use_env r_x r_ex) r_s"
  apply (rule_tac r_sb="r_x" in trans_leq_use_env)
   apply (simp)
  apply (rule_tac self_minus_leq_use_env)
  done
    
lemma dist_minus_leq_use_env: "\<lbrakk> leq_use_env r_x r_s \<rbrakk> \<Longrightarrow> leq_use_env (minus_use_env r_x r_ex) (minus_use_env r_s r_ex)"    
  apply (simp add: leq_use_env_def)
  apply (simp add: minus_use_env_def)
  apply (auto)
  apply (erule_tac x="x" in allE)
...
lemma comm_minus_use_env: "minus_use_env (minus_use_env r_sa r_sb) r_sc = minus_use_env (minus_use_env r_sa r_sc) r_sb"
  apply (case_tac "\<forall> x. minus_use_env (minus_use_env r_sa r_sb) r_sc x = minus_use_env (minus_use_env r_sa r_sc) r_sb x")
   apply (auto)
  apply (simp add: minus_use_env_def)
  apply (case_tac "r_sa x")
    apply (auto)
...
lemma diff_leq_use_env: "\<lbrakk> leq_use_env r_x r_s \<rbrakk> \<Longrightarrow> leq_use_env (diff_use_env r_x r_ex) r_s"
  apply (simp add: diff_use_env_def)
  apply (rule_tac minus_leq_use_env)
  apply (auto)
  done
...
lemma dist_diff_leq_use_env: "\<lbrakk> leq_use_env r_x r_s \<rbrakk> \<Longrightarrow> leq_use_env (diff_use_env r_x r_ex) (diff_use_env r_s r_ex)"
  apply (simp add: diff_use_env_def)
  apply (rule_tac dist_minus_leq_use_env)
  apply (auto)
  done    
...
lemma lhs_dist_dcl_use_env: "\<lbrakk> leq_use_env (comp_use_env (diff_use_env r_sa r_sx) (diff_use_env r_sb r_sx)) r_x \<rbrakk> \<Longrightarrow>
  ...
  apply (simp add: diff_use_env_def)
  apply (cut_tac r_s="r_sa" and r_x="r_sb" and r_ex="neg_use_env r_sx" in dist_minus_comp_use_env)
  apply (auto)
  done
